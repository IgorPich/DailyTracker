...
/**
 * LEGACY BACKUP/IMPORT BOUNDARY.
 *
 * Name, alias and occurrence-ID compatibility below exists only to restore
 * data written before the canonical exercise-library format. Runtime identity
 * decisions and history selectors must not depend on this module.
 */
