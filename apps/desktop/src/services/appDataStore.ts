...
import type { JournalPersistence } from './journalPersistence'
...
export const appDataStore: AppDataStore & Partial<ConfirmedTrackingPersistence & ProgramPersistence & JournalPersistence> = productionAuthorityRequested
